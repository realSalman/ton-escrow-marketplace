// This file imports JettonWallet from backend
// The class is kept in sync with server/wrappers/JettonWallet.js
import { Address, beginCell, Contract, ContractProvider, Sender, SendMode, Slice, Cell } from '@ton/core';

// Re-export the same class definition from backend
// Note: This maintains the exact same logic as server/wrappers/JettonWallet.js
